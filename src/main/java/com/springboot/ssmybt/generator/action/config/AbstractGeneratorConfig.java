...
import com.springboot.ssmybt.generator.engine.SimpleTemplateEngine;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doAdiGeneration() {
        YbtTemplateEngine ybtTemplateEngine = new SimpleTemplateEngine();
        ybtTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        ybtTemplateEngine.setSqlConfig(sqlConfig);
        ybtTemplateEngine.setTableInfo(tableInfo);
        ybtTemplateEngine.start();
    }
}
