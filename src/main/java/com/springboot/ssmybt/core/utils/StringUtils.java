...
* 类描述：字符串处理工具类
* 创建人：liuc
* 创建时间：2018年1月27日 下午11:05:49
* 修改人：liuc
* 修改时间：2018年1月27日 下午11:05:49
* 修改备注：
* @version
*
*/
public class StringUtils {
	...
	* @since CodingExample　Ver(编码范例查看) 1.1
	...
	/**
	* @author liuc
	* @date 2018年3月10日 上午12:11:36
	* @Description: 对象是否不为空
	* @return boolean    返回类型
	* @param @param delimiterStatementStart
	* @param @return(参数)
	* @throws
	* @since CodingExample　Ver(编码范例查看) 1.1
	*/
	...
	* @since CodingExample　Ver(编码范例查看) 1.1
    ...
    public static String getWebRootPath(String filePath) {
        try {
            String path = StringUtils.class.getClassLoader().getResource("").toURI().getPath();
